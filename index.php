        ...
        <section id="pagina-home">
            <header>
                ...
                <nav class="menu-principal">
                    <ul>
                        <li><a href="mailto:lucasdelphino122@gmail.com" class="link-ativo">contato</a></li>
                    </ul>
                </nav>
            </header>
            <main>
            ...
            <dav class="cadastro">
                <div class="col-12 col-sm2 col-md-6 col-lg-6 mt-2">
                    <div class="card" style="height:100%">
                        ...
                        <form action="anime-salvar.php" method="POST" enctype="multipart/form-date">
                            <div class="card-body">
                                <div class="mb-3">
                                ...
                                <div>
                                    <button type="submit" class="btn btn-primary btn-lg">Slavar</button>
                                </div>
                        </form>
                    </div>
                </div>
